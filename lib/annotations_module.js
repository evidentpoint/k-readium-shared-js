...
var EpubAnnotationsModule = function (contentDocumentFrame, annotationsManagerView, annotationCSSUrl, spineItem) {
    ...
    EpubAnnotations.ReflowableAnnotations = Backbone.Model.extend({
        ...
        redraw: function (options) {
            ...
            _.each(this.get("highlights"), function (highlightGroup) {
                var visible  = that.cfiIsBetweenTwoCfis(highlightGroup.get("CFI"), options.firstVisibleCfi.contentCFI, options.lastVisibleCfi.contentCFI);
        ...
        addHighlight: function (CFI, id, type, styles, includeMedia, options) {
            var CFIRangeInfo;
            var range;
            var rangeStartNode;
            var rangeEndNode;
            ...
            this.addHighlightHelper(
                ...
                startNode, endNode, 0, leftAddition, includeMedia, options);
        ...
        addHighlightHelper: function (CFI, annotationId, type, styles, highlightedNodes,
                                      range, startNode, endNode, offsetTop, offsetLeft, includeMedia, options) {
            if (!offsetTop) {
            ...
            if (options && options.firstVisibleCfi && options.lastVisibleCfi) {
    ...
    return {
        ...
        addHighlight: function (CFI, id, type, styles, options) {
            return reflowableAnnotations.addHighlight(CFI, id, type, styles, undefined, options);
        },
        updateAnnotation: function (id, type, styles) {
